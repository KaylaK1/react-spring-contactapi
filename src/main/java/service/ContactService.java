...
public class ContactService {
    ...
    // Filter the name to make sure it has an extension (existence of ".")
    // If there is an extension, transform the name with map and find the file extension
    // where the substring begins with ".".
    ...
    private final BiFunction<String, MultipartFile, String> photoFunction = (id, image) -> {
        ...
        try {
            // Gives a specific location on the host to save file
